    ...
    <>
      ...
      <section style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '120px 24px 80px', position: 'relative', overflow: 'hidden', background: 'radial-gradient(ellipse at 30% 20%, rgba(212,168,83,0.05) 0%, transparent 50%), radial-gradient(ellipse at 70% 80%, rgba(45,212,191,0.03) 0%, transparent 50%)' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 900 }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '6px 16px', borderRadius: 20, background: 'rgba(212,168,83,0.12)', color: '#d4a853', fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: 1.5, marginBottom: 28, border: '1px solid rgba(212,168,83,0.15)' }}>
            ⚡ Human Optimization Philosophy
          </div>
          <h1 style={{ fontSize: 'clamp(2.5rem, 6vw, 4.5rem)', fontWeight: 900, lineHeight: 1.05, marginBottom: 24 }}>
            <span style={{ background: 'linear-gradient(135deg, #e8c97a, #2dd4bf)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Rebuild The</span><br />
            <span style={{ background: 'linear-gradient(135deg, #e8c97a, #2dd4bf)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Human System</span>
          </h1>
      ...
      <Section dark>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 48, alignItems: 'center' }}>
          <div>
            <h2 style={{ fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', fontWeight: 700, marginBottom: 20 }}>The Modern World <span style={{ background: 'linear-gradient(135deg, #e8c97a, #2dd4bf)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Drains You</span></h2>
      ...
      <Section>
        <div style={{ textAlign: 'center', maxWidth: 700, margin: '0 auto' }}>
          <h2 style={{ fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', fontWeight: 700, marginBottom: 20 }}>Ready to <span style={{ background: 'linear-gradient(135deg, #e8c97a, #2dd4bf)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Rebuild</span>?</h2>
      ...
      <Section dark>
        <div style={{ textAlign: 'center', maxWidth: 600, margin: '0 auto' }}>
          <h2 style={{ fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', fontWeight: 700, marginBottom: 16 }}>Join The <span style={{ background: 'linear-gradient(135deg, #e8c97a, #2dd4bf)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Letters</span></h2>
      ...
      <Section>
        <div style={{ textAlign: 'center', maxWidth: 700, margin: '0 auto' }}>
          <h2 style={{ fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', fontWeight: 700, marginBottom: 20 }}>Your Body Is <span style={{ background: 'linear-gradient(135deg, #e8c97a, #2dd4bf)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Architecture</span></h2>
